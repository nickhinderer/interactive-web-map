...
public class Query {
    ...
    private String sql;
    private String searchCriteria = "FROM world " + "INNER JOIN continent ON world.continent = continent.id " + "INNER JOIN country ON world.iso_country = country.id " + "INNER JOIN region ON world.iso_region = region.id ";
